...
class ITransport {
  public:
     ...
     */
    virtual bool sendData(const std::vector<uint8_t>& inData, std::vector<uint8_t>& output) = 0;
    /**
...
class SocketTransport : public ITransport {
  ...
  public:
     ...
     */
    bool sendData(const std::vector<uint8_t>& inData, std::vector<uint8_t>& output) override;
    /**
     * Closes the connection.
     */
